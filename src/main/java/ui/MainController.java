...
public class MainController extends BaseControllerState {
    ...
    public void openWallet(){
        ...
        if (wallet != null){
            ...
            WalletApp.switchScene("wallet.fxml", "it.kolleg.sample.wallet");
    ...
    public void newWallet() throws InvalidFeeException {
        ...
        this.getWalletList().addWallet(new Wallet("Name: "+selectedCryptoCurrency.name() + "Wallet", selectedCryptoCurrency, new BigDecimal("1") ));
