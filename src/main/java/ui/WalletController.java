...
import it.kolleg.sample.WalletApp;
...
public class WalletController extends BaseControllerState {
    ...
    public void buy() {
        ...
        if (result.isPresent()) {
            ...
            } catch (GetCurrentPriceException | InsufficientBalanceException |
    ...
    public void sell() {
        ...
        if (result.isPresent()) {
            try {
                ...
                WalletApp.showErrorDialog("Invalid amount. Insert a number!");
            } catch (InsufficiantAmountException | GetCurrentPriceException | InvalidAmountException exception) {
                WalletApp.showErrorDialog(exception.getMessage());
                exception.printStackTrace();
            }
        }
